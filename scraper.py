...
if __name__ == "__main__":
    ...
    for data in urls:
        ...
        for result in table:
            ...
            d3 = result.findAll('span', attrs={'class': 'tag-tooltip tag-select label label-xs label-primary'})
            ...
            response_autocomplete = requests.request("POST", post_autocomplete_url, data=payload_autocomplete,
                                                     headers=headers)
